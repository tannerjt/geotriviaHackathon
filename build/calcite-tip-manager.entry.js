...
const CalciteTipManager = class {
  ...
  render() {
    ...
    return (h("section", { "aria-hidden": closed.toString(), class: CSS.container, hidden: closed, onKeyUp: this.tipManagerKeyUpHandler, ref: this.storeContainerRef, tabIndex: 0 }, h("header", { class: CSS.header }, h(CalciteHeading, { class: CSS.heading, level: headingLevel || HEADING_LEVEL }, groupTitle), h("calcite-action", { class: CSS.close, icon: ICONS.close, onClick: this.hideTipManager, scale: "m", text: closeLabel })), h("div", { class: {
